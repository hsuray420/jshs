...
type IntroCard = { icon: SiteIconName; eyebrow: string; title: string; body: string; action?: { label: string; href: string } };

const introCards: readonly IntroCard[] = [
  { icon: "shield", eyebrow: "資料查證", title: "依公開與官方來源整理", body: "本站盡力整理公開及官方來源；重要升學決定仍請以招生委員會最新公告為準。" },
  { icon: "sparkle", eyebrow: "公益維護", title: "目前核心功能免費使用", body: "本站目前核心功能可免費使用。若覺得網站有幫助，歡迎轉發給需要的人，或以小額捐款支持維護。", action: { label: "贊助我們", href: "/support" } },
