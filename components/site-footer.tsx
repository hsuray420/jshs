...
export function SiteFooter() {
  return (
    <footer className="border-t border-[var(--border-light)] bg-white py-9 jshs-section">
      <div className="mx-auto grid w-[min(1180px,calc(100%-32px))] gap-6 text-sm text-[var(--text-secondary)] lg:grid-cols-[1fr_auto_1fr] lg:items-center">
