  ...
  return (
    <section className="mx-auto w-[min(1120px,calc(100%-32px))] py-10">
      <div className="grid gap-5 p-6 jshs-surface-card">
        <div className="text-center"><h2 className="text-2xl">— 選擇捐款金額 —</h2><p className="mt-2 text-sm leading-6 jshs-muted-copy">感謝你支持全國國中升學資訊網。選擇或輸入金額後，系統會前往綠界付款頁面。</p></div>
