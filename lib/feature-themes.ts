...
export const featureThemes: Record<FeatureThemeName, Readonly<{
  ...
  tools: { primary: "#237a3b", primaryHover: "#17612e", surface: "#edf9f0", surfaceStrong: "#d9f0df", border: "#b8dfc3", text: "#175a30", icon: "#237a3b", illustrationAccent: "#69b77e" },
  planner: { primary: "#975800", primaryHover: "#744300", surface: "#fff7df", surfaceStrong: "#ffedbd", border: "#f4d58d", text: "#744400", icon: "#975800", illustrationAccent: "#e8a32c" },
