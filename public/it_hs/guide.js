...
function initOverviewCards() {
    ...
    const overviewContent = {
        ...
        'overview-five-year': {
            pill: '五專',
            title: '適合想提早進入專業領域，並完成五年一貫學習的學生',
            steps: [
                {
                    title: '學習特色',
                    text: '五年制專科學校把高中階段與專科專業訓練連在一起，從基礎課程逐步進入實作、實習與專業能力培養。'
                },
                {
                    title: '升學與出路',
                    text: '完成五專可取得副學士學位，之後可透過甄試或其他管道銜接二技、技術校院或投入職場；各校系招生條件與名額須以當年度簡章為準。'
                },
                {
                    title: '適合的孩子',
                    text: '如果你已經對護理、醫事、商管、設計、工程或其他專業領域有興趣，希望用較長時間累積專業，五專值得納入比較。'
                },
                {
                    title: '建議你這樣想',
                    text: '五專不是單純提早選校，而是提早選擇專業學習路線；填志願前要一起比較校系內容、地點、實習安排與未來銜接。'
                }
            ]
        }
    };
