...
export const metadata: Metadata = { title: "全站搜尋與升學百科｜全國國中升學資訊網", description: "搜尋學校、科系、群科、文章、規則名詞、重要日程與官方來源。", alternates: { canonical: "/search" }, robots: { index: false, follow: true } };
