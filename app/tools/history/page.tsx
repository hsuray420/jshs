...
export default function ScoreHistoryPage() { return <main className="min-h-screen jshs-page-shell"><SiteHeader activeHref="/tools" /><ScoreHistoryWorkspace /><SiteFooter /></main>; }
