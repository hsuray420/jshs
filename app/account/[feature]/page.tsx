...
const pages: Record<string, SupportPage> = {
  data: { eyebrow: "帳號與資料", title: "匯入／匯出資料", description: "下載自己的偏好與規劃進度。", sections: [{ title: "匯出", body: "帳號中心可下載自己的規劃與偏好資料。" }, { title: "資料安全", body: "匯出的檔案請自行妥善保存。" }], action: { label: "回到帳號中心", href: "/account" } },
