...
export const metadata: Metadata = { title: "AI 小助手 Beta｜全國國中生升學資訊網", description: "AI 小助手 Beta：可以回答一般問題，也能查找本站升學與學校資料。", alternates: { canonical: "/ai" }, robots: { index: false, follow: true } };
