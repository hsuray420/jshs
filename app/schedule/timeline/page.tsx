...
export const metadata: Metadata = { title: "重要時程｜升學日程｜全國國中生升學資訊網", description: "以 Timeline 查看已公告、待公告與上年度參考的升學日期，並在頁內比較就學區與匯出 ICS。", alternates: { canonical: "/schedule/timeline" } };
