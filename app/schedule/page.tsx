...
export default function SchedulePage() {
  return <main className="min-h-screen jshs-page-shell jshs-feature-guide"><SiteHeader activeHref="/schedule" /><FeaturePageBand tone="guide" /><DistrictGate><ScheduleWorkspace /></DistrictGate><SiteFooter /></main>;
}
