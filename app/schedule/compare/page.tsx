...
export default function ScheduleComparePage() { return <main className="min-h-screen jshs-page-shell"><SiteHeader activeHref="/schedule" /><DistrictGate><ScheduleWorkspace view="compare" /></DistrictGate><SiteFooter /></main>; }
