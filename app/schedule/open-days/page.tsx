...
export default function OpenDaysPage() { return <main className="min-h-screen jshs-page-shell"><SiteHeader activeHref="/schedule" /><DistrictGate><ScheduleWorkspace view="open-days" /></DistrictGate><SiteFooter /></main>; }
