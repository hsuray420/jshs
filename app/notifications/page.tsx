...
export const metadata: Metadata = { title: "通知與提醒｜全國國中升學資訊網", description: "管理分數、LINE、Email 與重要日期提醒。", alternates: { canonical: "/notifications" }, robots: { index: false, follow: false } };
