...
const pages: Record<string, SupportPage> = {
  ...
  calendar: { eyebrow: "通知與提醒", title: "重要日期訂閱設定", description: "選擇要追蹤的會考、報名與升學日期。", sections: [{ title: "依就學區顯示", body: "重要日期會依目前選擇的就學區與資料年度呈現，涉及權益仍請核對官方公告。" }, { title: "加入個人行事曆", body: "校園開放日與升學節點可在升學日程頁整理，並匯出 ICS 到手機或行事曆。" }], action: { label: "前往升學日程", href: "/schedule" } },
};
