...
const pages: Record<string, SupportPage> = {
  ...
  email: { eyebrow: "通知與提醒", title: "Email 週報", description: "整理一週的試算、志願與升學進度。", sections: [{ title: "訂閱原則", body: "只有你主動開通的通知類別才會寄送；未設定 Email 時不會寄出。" }, { title: "內容範圍", body: "週報以你的進度摘要與下一步為主，不會公開個人規劃內容。" }], action: { label: "管理通知設定", href: "/notifications" } },
