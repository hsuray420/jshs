...
const cards: readonly HubCard[] = [
  { eyebrow: "SAVED SCHOOLS", title: "收藏校科", description: "把有興趣的學校與科別先收進候選池，保留通勤、課程與待確認問題。", href: "/districts", action: "選區後開始收藏", status: "本機保存" },
  { eyebrow: "WISH ORDER", title: "我的志願", description: "用挑戰、適中與穩定理解風險，再依正式規則與真實意願整理順序。", href: "/districts", action: "進入志願規劃", status: "本機保存" },
  { eyebrow: "CHECKLIST", title: "待辦清單", description: "記錄簡章核對、校園了解、家庭討論與送出前檢查，不讓重要事項只存在記憶裡。", href: "/news/parents", action: "查看家庭討論指南", status: "本機保存" },
