...
export default async function AdminDashboard() {
  ...
  const [settings, files, content, notifications, reviews] = await Promise.all([listSiteSettings(), listAdminFiles(), listContentEntries(), listNotificationSettings(), listPendingSchoolReviews()]);
  ...
  const tasks = reviews.length + Number(!donationReady);
  return <>
