...
export default function HomePage() {
  return <main className="min-h-screen jshs-page-shell"><SiteHeader activeHref="/" />
    <section className="jshs-home-hero"><PageContainer className="jshs-home-hero-inner"><div><p className="jshs-eyebrow">{SERVICE_YEAR} 學年度升學規劃</p><h1>找到你的方向，<br />邁向理想的學校！</h1><p className="jshs-muted-copy">從找學校、成績試算到志願規劃，<br className="hidden sm:block" />用清楚的工具陪你完成每一步。</p><div className="mt-6 flex flex-wrap gap-3"><Link href="/schools" className="jshs-button-primary px-5">開始找學校</Link><Link href="/tools" className="jshs-button-secondary px-5">先算成績</Link></div></div><div className="jshs-home-hero-visual" aria-label="學生升學規劃插圖"><span className="jshs-hero-cloud is-one" /><span className="jshs-hero-cloud is-two" /><div className="jshs-hero-school"><SiteIcon name="school" size={52} /></div><div className="jshs-hero-student is-left"><SiteIcon name="account" size={54} /></div><div className="jshs-hero-student is-right"><SiteIcon name="account" size={54} /></div></div></PageContainer></section>
