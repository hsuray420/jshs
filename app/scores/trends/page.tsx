...
export default function ScoreTrendsPage() { return <main className="min-h-screen jshs-page-shell jshs-feature-score"><SiteHeader activeHref="/scores" /><FeatureHero theme="tools" eyebrow="成績分析 · 成績趨勢" title="用已保存成績查看變化" description="趨勢需要真實保存的模考資料；資料不足時只顯示空狀態，不產生推估線。" illustration="score-summary" /><MockScoreEmptyState /><SiteFooter /></main>; }
